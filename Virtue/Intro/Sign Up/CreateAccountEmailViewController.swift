...
class CreateAccountEmailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let tap = UITapGestureRecognizer.init(target: self, action: #selector(CreateAccountEmailViewController.dismissKeyboard))
