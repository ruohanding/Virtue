//
//  CompletedEventsTableViewController.swift
//  Virtue
//
...
class CompletedEventsTableViewController: UITableViewController{
...
extension CompletedEventsTableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "completedViewCell") as! OpportunityTableViewCell
